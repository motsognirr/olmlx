...
# NOTE: the streaming thinking-block stripper that used to live here moved to
# ``olmlx/routers/thinking_split.py`` (issue #471) — one state machine now
# backs the Ollama splitter, the OpenAI stripper, and the Anthropic
# content-block emitter.
